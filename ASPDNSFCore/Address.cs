...
namespace AspDotNetStorefrontCore
{
    ...
    public class Address
    {
        ...
        private String m_Zip4 = String.Empty;
        #endregion
        ...
        {
            return DisplayString(Checkout, true, "<br/>");
        }
        ...
        {
            return DisplayString(false, false, "<br/>");
        }
        ...
        /// <returns>Returns the display string.</returns>
        public string DisplayString(bool Checkout, bool IncludePhone, String Separator)
        {
            string s = String.Empty;

            StringBuilder tmpS = new StringBuilder(1000);
            tmpS.Append(String.Format("{0} {1}{2}", FirstName, LastName, Separator));
            tmpS.Append(CommonLogic.IIF(m_Company.Length != 0, Company + Separator, ""));
            tmpS.Append(CommonLogic.IIF(m_Address1.Length != 0, Address1 + Separator, ""));
            tmpS.Append(CommonLogic.IIF(m_Address2.Length != 0, Address2 + Separator, ""));
            tmpS.Append(CommonLogic.IIF(m_Suite.Length != 0, Suite + Separator, ""));
            s = String.Format("{0}, {1} {2}", City, State, Zip);
            if (s.Length > 3)
            {
                tmpS.Append(s + Separator);
            }
            tmpS.Append(CommonLogic.IIF(m_Country.Length != 0, Country + Separator, ""));
            if (IncludePhone)
            {
                tmpS.Append(CommonLogic.IIF(m_Phone.Length != 0, Phone + Separator, ""));
            }
        ...
        public string DisplayECheckHTML()
        {
            ...
            tmpS.Append(PaymentMethodLastUsed + "<br/>");
            tmpS.Append(ECheckBankName + "<br/>");
            tmpS.Append(String.Format("{0} : ***-{1}<br/>", ECheckBankABACode, ECheckBankAccountNumber.Substring(ECheckBankAccountNumber.Length - 5, 5)));
            return tmpS.ToString();
        }
        ...
        public string InputHTML(String FieldPrefix, bool IncludeFormValidation)
        {
            ...
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.49", m_SkinID, m_LocaleSetting) + "</td>");
            ...
            // AddressNickName
            tmpS.Append("        <input type=\"text\" name=\"AddressNickName" + FieldPrefix + "\" id=\"AddressNickName" + FieldPrefix + "\" size=\"30\" maxlength=\"100\" value=\"" + NickName + "\"><!-- COPY FROM ABOVE -->");
            tmpS.Append("        </td>");
            tmpS.Append("      </tr>");
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.2", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");
            ...
            // AddressFirstName
            tmpS.Append("        <input type=\"text\" name=\"AddressFirstName" + FieldPrefix + "\" id=\"AddressFirstName" + FieldPrefix + "\" size=\"20\" maxlength=\"50\" value=\"" + m_FirstName + "\" >");
            if (IncludeFormValidation)
            {
            ...
            tmpS.Append("      </tr>");
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.3", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");
            ...
            // AddressLastName
            tmpS.Append("        <input type=\"text\" name=\"AddressLastName" + FieldPrefix + "\" id=\"AddressLastName" + FieldPrefix + "\" size=\"20\" maxlength=\"50\" value=\"" + m_LastName + "\">");
            if (IncludeFormValidation)
            {
            ...
            tmpS.Append("      </tr>");
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.4", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");
            ...
            // AddressPhone
            tmpS.Append("        <input type=\"text\" name=\"AddressPhone" + FieldPrefix + "\" id=\"AddressPhone" + FieldPrefix + "\" size=\"25\" maxlength=\"25\" value=\"" + m_Phone + "\">");
            if (IncludeFormValidation)
            {
            ...
            tmpS.Append("      </tr>");
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.5", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");
            ...
            // AddressCompany
            tmpS.Append("        <input type=\"text\" name=\"AddressCompany" + FieldPrefix + "\" id=\"AddressCompany" + FieldPrefix + "\" size=\"34\" maxlength=\"100\" value=\"" + m_Company + "\">");
            tmpS.Append("        </td>");
            tmpS.Append("      </tr>");

            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.58", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");
            ...
            if (!CommonLogic.IsStringNullOrEmpty(residenceTypePostbackValue))
            {
                ...
                // ResidenceType
                tmpS.Append("        <select size=\"1\" name=\"ResidenceType" + FieldPrefix + "\" id=\"ResidenceType" + FieldPrefix + "\">");
            ...
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.6", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");
            ...
            // AddressAddress1
            tmpS.Append("        <input type=\"text\" name=\"AddressAddress1" + FieldPrefix + "\" id=\"AddressAddress1" + FieldPrefix + "\" size=\"34\" maxlength=\"100\" value=\"" + m_Address1 + "\">");
            if (IncludeFormValidation)
            {
            ...
            tmpS.Append("      </tr>");
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.7", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");
            ...
            // AddressAddress2
            tmpS.Append("        <input type=\"text\" name=\"AddressAddress2" + FieldPrefix + "\" id=\"AddressAddress2" + FieldPrefix + "\" size=\"34\" maxlength=\"100\" value=\"" + m_Address2 + "\">");
            tmpS.Append("        </td>");
            tmpS.Append("      </tr>");
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.8", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");
            ...
            //AddressSuite
            tmpS.Append("        <input type=\"text\" name=\"AddressSuite" + FieldPrefix + "\" id=\"AddressSuite" + FieldPrefix + "\" size=\"34\" maxlength=\"50\" value=\"" + m_Suite + "\">");
            tmpS.Append("        </td>");
            tmpS.Append("      </tr>");
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.9", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");
            ...
            // AddressCity
            tmpS.Append("        <input type=\"text\" name=\"AddressCity" + FieldPrefix + "\" id=\"AddressCity" + FieldPrefix + "\" size=\"34\" maxlength=\"50\" value=\"" + m_City + "\">");
            if (IncludeFormValidation)
            {
            ...
            tmpS.Append("      </tr>");
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.10", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");

            // AddressState
            tmpS.Append("        <select size=\"1\" name=\"AddressState" + FieldPrefix + "\" id=\"AddressState" + FieldPrefix + "\">");
            ...
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.12", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");
            ...
            // AddressZip
            tmpS.Append("        <input type=\"text\" name=\"AddressZip" + FieldPrefix + "\" id=\"AddressZip" + FieldPrefix + "\" size=\"14\" maxlength=\"10\" value=\"" + m_Zip + "\">");
            if (IncludeFormValidation)
            {
            ...
            tmpS.Append("      </tr>");
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"25%\">" + AppLogic.GetString("address.cs.53", m_SkinID, m_LocaleSetting) + "</td>");
            tmpS.Append("        <td width=\"75%\">");
            ...
            tmpS.Append("        <select name=\"AddressCountry" + FieldPrefix + "\" id=\"AddressCountry" + FieldPrefix + "\" size=\"1\" " + script + ">");
        ...
        public String InputCardHTML(Customer ThisCustomer, bool Validate, bool CheckForTerms)
        {
            ...
            if (ThisCustomer.MasterShouldWeStoreCreditCardInfo || CommonLogic.GetThisPageName(false).Equals("checkoutpayment.aspx", StringComparison.InvariantCultureIgnoreCase) || CommonLogic.GetThisPageName(false).Equals("editaddressrecurring.aspx", StringComparison.InvariantCultureIgnoreCase) || CommonLogic.GetThisPageName(false).Equals("checkout1.aspx", StringComparison.InvariantCultureIgnoreCase))
            {
                tmpS.Append("      <tr>");
                tmpS.Append("        <td width=\"35%\">" + AppLogic.GetString("address.cs.23", m_SkinID, m_LocaleSetting) + "</td>\n");
                tmpS.Append("        <td width=\"65%\">\n");
                tmpS.Append("        <input type=\"text\" name=\"CardName\" id=\"CardName\" size=\"20\" maxlength=\"100\" value=\"" + HttpContext.Current.Server.HtmlEncode(CardName.Trim()) + "\">\n");
                if (Validate)
                {
                ...
                tmpS.Append("      <tr>");
                tmpS.Append("        <td width=\"35%\">" + AppLogic.GetString("address.cs.25", m_SkinID, m_LocaleSetting) + "</td>");
                tmpS.Append("        <td width=\"65%\">\n");

                tmpS.Append("        <input type=\"text\" autocomplete=\"off\" name=\"CardNumber\" id=\"CardNumber\" size=\"20\" maxlength=\"20\" value=\"" + AppLogic.SafeDisplayCardNumber(CardNumber, "Address", m_AddressID) + "\"> " + AppLogic.GetString("shoppingcart.cs.106", m_SkinID, m_LocaleSetting) + "\n");
                if (Validate)
                {
                ...
                if (CommonLogic.GetThisPageName(false).Equals("checkoutpayment.aspx", StringComparison.InvariantCultureIgnoreCase) || CommonLogic.GetThisPageName(false).Equals("checkout1.aspx", StringComparison.InvariantCultureIgnoreCase))
                {
                    tmpS.Append("      <tr>");
                    tmpS.Append("        <td width=\"35%\">" + AppLogic.GetString("address.cs.28", m_SkinID, m_LocaleSetting) + "</td>");
                    tmpS.Append("        <td width=\"65%\">\n");
                ...
                tmpS.Append("      <tr>");
                tmpS.Append("        <td width=\"35%\">" + AppLogic.GetString("address.cs.31", m_SkinID, m_LocaleSetting) + "</td>");
                tmpS.Append("        <td width=\"65%\">\n");
                ...
                tmpS.Append("      <tr>");
                tmpS.Append("        <td width=\"35%\">" + AppLogic.GetString("address.cs.33", m_SkinID, m_LocaleSetting) + "</td>");
                tmpS.Append("        <td width=\"65%\">\n");
                ...
                if (AppLogic.AppConfigBool("ShowCardStartDateFields"))
                {
                    ...
                    tmpS.Append("     <tr><td colspan=2 height=2></td></tr>");
                    tmpS.Append("      <tr>");
                    tmpS.Append("        <td width=\"35%\">*" + AppLogic.GetString("address.cs.59", m_SkinID, m_LocaleSetting) + "</td>");
                    tmpS.Append("        <td width=\"65%\">\n");
                    ...
                    tmpS.Append("     <tr><td colspan=2 height=2></td></tr>");
                    tmpS.Append("      <tr>");
                    tmpS.Append("        <td width=\"35%\">" + AppLogic.GetString("address.cs.61", m_SkinID, m_LocaleSetting) + "</td>");
                    tmpS.Append("        <td width=\"65%\">\n");
                    tmpS.Append("        <input type=\"text\" autocomplete=\"off\" name=\"CardIssueNumber\" id=\"CardIssueNumber\" size=\"2\" maxlength=\"2\" value=\"" + CardIssueNumber + "\"> " + AppLogic.GetString("address.cs.63", m_SkinID, m_LocaleSetting) + "\n");
                    tmpS.Append("        </td>");
                    tmpS.Append("      </tr>");
                    tmpS.Append("      <tr><td width=\"100%\" height=\"10\" colspan=\"2\"></td></tr>");
                }
        ...
        public String InputCardHTML(Customer ThisCustomer, bool Validate, bool CheckForTerms, bool populatecardnumber)
        {
            ...
            if (ThisCustomer.MasterShouldWeStoreCreditCardInfo || CommonLogic.GetThisPageName(false).Equals("checkoutpayment.aspx", StringComparison.InvariantCultureIgnoreCase) || CommonLogic.GetThisPageName(false).Equals("editaddressrecurring.aspx", StringComparison.InvariantCultureIgnoreCase) || CommonLogic.GetThisPageName(false).Equals("checkout1.aspx", StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                tmpS.Append("        <input type=\"text\" autocomplete=\"off\" name=\"CardNumber\" id=\"CardNumber\" size=\"20\" maxlength=\"20\" value=\"" + CardNumberForDisplay + "\"> " + AppLogic.GetString("shoppingcart.cs.106", m_SkinID, m_LocaleSetting) + "\n");
                if (Validate)
                {
                    tmpS.Append("        <input type=\"hidden\" name=\"CardNumber_vldt\" value=\"[req][len=8][blankalert=" + AppLogic.GetString("address.cs.26", m_SkinID, m_LocaleSetting) + "][invalidalert=" + AppLogic.GetString("address.cs.27", m_SkinID, m_LocaleSetting) + "]\">\n");
                }
                ...
                if (CommonLogic.GetThisPageName(false).Equals("checkoutpayment.aspx", StringComparison.InvariantCultureIgnoreCase) || CommonLogic.GetThisPageName(false).Equals("checkout1.aspx", StringComparison.InvariantCultureIgnoreCase))
                {
                    ...
                    tmpS.Append("        <td width=\"35%\">" + AppLogic.GetString("address.cs.28", m_SkinID, m_LocaleSetting) + "</td>");
                    tmpS.Append("        <td width=\"65%\">\n");
                    tmpS.Append("        <input type=\"text\" autocomplete=\"off\" name=\"CardExtraCode\" id=\"CardExtraCode\" size=\"5\" maxlength=\"10\" value=\"" + CommonLogic.IIF(populatecardnumber, CardExtraCode, "") + "\">\n");
                    tmpS.Append("(<a id=\"aCardCodeToolTip\" href=\"javascript:void(0);\" style=\"cursor: normal;\" >" + AppLogic.GetString("address.cs.50", m_SkinID, m_LocaleSetting) + "</a>)");
        ...
        public string InputECheckHTML(bool Validate)
        {
            ...
            tmpS.Append("  <tr><td width=\"100%\" height=\"10\" colspan=\"2\"></td></tr>");
            tmpS.Append("  <tr>");
            tmpS.Append("    <td width=\"35%\">" + AppLogic.GetString("address.cs.36", m_SkinID, m_LocaleSetting) + "&nbsp;</td>\n");
            tmpS.Append("    <td width=\"65%\">\n");
            tmpS.Append("    <input type=\"text\" name=\"ECheckBankAccountName\" id=\"ECheckBankAccountName\" size=\"20\" maxlength=\"50\" value=\"" + HttpContext.Current.Server.HtmlEncode(m_FirstName + " " + m_LastName) + "\">\n");
            if (Validate)
            {
            ...
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"35%\">" + AppLogic.GetString("address.cs.38", m_SkinID, m_LocaleSetting) + "</td>\n");
            tmpS.Append("        <td width=\"65%\">\n");
            tmpS.Append("        <input type=\"text\" name=\"ECheckBankName\" id=\"ECheckBankName\" size=\"20\" maxlength=\"50\" value=\"" + HttpContext.Current.Server.HtmlEncode(ECheckBankName) + "\"> " + AppLogic.GetString("address.cs.40", m_SkinID, m_LocaleSetting) + "\n");
            if (Validate)
            {
            ...
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"35%\">" + AppLogic.GetString("address.cs.41", m_SkinID, m_LocaleSetting) + "&nbsp;</td>\n");
            tmpS.Append("        <td width=\"65%\">\n");
            tmpS.Append("        &nbsp;<img src=\"" + AppLogic.LocateImageURL("App_Themes/skin_" + m_SkinID.ToString() + "/images/check_aba.gif") + "\"><input type=\"text\" autocomplete=\"off\" name=\"ECheckBankABACode\" id=\"ECheckBankABACode\" size=\"9\" maxlength=\"9\" value=\"" + HttpContext.Current.Server.HtmlEncode(ECheckBankABACodeMasked) + "\"><img src=\"" + AppLogic.LocateImageURL("App_Themes/skin_" + m_SkinID.ToString() + "/images/check_aba.gif", m_LocaleSetting) + "\"> " + AppLogic.GetString("address.cs.42", m_SkinID, m_LocaleSetting) + "\n");
            if (Validate)
            {
            ...
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"35%\">" + AppLogic.GetString("address.cs.44", m_SkinID, m_LocaleSetting) + "&nbsp;</td>\n");
            tmpS.Append("        <td width=\"65%\">\n");
            tmpS.Append("&nbsp;<input type=\"text\" autocomplete=\"off\" name=\"ECheckBankAccountNumber\" id=\"ECheckBankAccountNumber\" size=\"15\" maxlength=\"25\" value=\"" + HttpContext.Current.Server.HtmlEncode(ECheckBankAccountNumberMasked) + "\"><img src=\"" + AppLogic.LocateImageURL("App_Themes/skin_" + m_SkinID.ToString() + "/images/check_account.gif") + "\"> " + AppLogic.GetString("address.cs.45", m_SkinID, m_LocaleSetting) + "\n");
            if (Validate)
            {
            ...
            tmpS.Append("      <tr>");
            tmpS.Append("        <td width=\"35%\">" + AppLogic.GetString("address.cs.47", m_SkinID, m_LocaleSetting) + "&nbsp;</td>");
            tmpS.Append("        <td width=\"65%\">\n");
            tmpS.Append("        <select size=\"1\" name=\"ECheckBankAccountType\" id=\"ECheckBankAccountType\">");
            ...
            tmpS.Append("	  <tr><td colspan=\"2\">" + String.Format(AppLogic.GetString("address.cs.48", m_SkinID, m_LocaleSetting), AppLogic.LocateImageURL("App_Themes/skin_" + m_SkinID.ToString() + "/images/check_micr.gif")) + "</td></tr>");
            tmpS.Append("</table>");
