...
#region LovelyEcom Add For TaxCloud
    ...
    public partial class taxClass : AdminPageBase 
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ShowAddPanel(false);
                #region LovelyEcom Add For Taxcloud Tax Classes
                btnLoad.Visible = AppLogic.AppConfigBool("taxcloud.Enabled");
                #endregion
            }
        }
        ...
        {
            TaxCloudTICs tics = new TaxCloudTICs();
            tics.LoadFeed();
            tics.SaveToDB();
            buildGridData();
