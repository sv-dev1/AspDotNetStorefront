...
namespace AspDotNetStorefront
{
    ...
    public partial class createaccount : SkinBase
    {
        ...
        {//LovelyEcom Add
			...
			{
				ErrorMsgLabel.Text = "gw.checkoutbyamazon.display.3".StringResource();
				return;
			}
            ...
            {
                ErrorMsgLabel.Text += "<br /><br />" + AppLogic.GetString("createaccount.aspx.84", 1, Localization.GetDefaultLocale()) + "<br /><br />";
