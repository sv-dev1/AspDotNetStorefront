...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="PageContent">
    <asp:Panel ID="pnlContent" runat="server">
            <asp:Label ID="ErrorMsgLabel" CssClass="errorLg" runat="Server" Visible="false"></asp:Label>
        <div class="address_main" >
         <asp:Label ID="lblPOBoxError" Visible="false" runat="server" ForeColor="Red" Font-Bold="true"/>
             <%-- LovelyEcom Add--%>
         <asp:Label ID="lbAddressError" Visible="true" runat="server" ForeColor="Red" Font-Bold="true"/>
         <%--LovelyEcom End--%>
        ...
        <asp:ValidationSummary DisplayMode="List" ID="vsAddAddress" ShowMessageBox="false"
            ...
            <table id="tblNewAddress" class="addaddresstbl" width="100%" runat="server" visible="false">
               
                <tr>
                    <td width="100%" class="addressaddctrl">
                ...
                <tr>
                    <td width="100%" class="addressbuttonbg addressbuttonbg_footer" >
            ...
            <div class="addressdatalist_header">
                <br />
            </div>
                            ...
                            <asp:DataList ID="dlAddress" runat="server" Width="100%" OnEditCommand="dlAddress_EditCommand"
                                ...
                                <EditItemTemplate>
                                    <asp:Table ID="tblEdit" runat="server" Width="100%" class="addressEdittbl">
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell class="addresseditctrl">
                                        ...
                                        <asp:TableRow>
                                            <asp:TableCell Width="100%" class="addressbuttonbg">
            ...
            <div align="center" width="100%" style="padding-top: 20px">
                <asp:Button ID="btnReturnUrl" runat="server" Text="<%$ Tokens:StringResource,account.aspx.61 %>"
